const Ticket = ({ ticket }) => {
  ...
  return (
    <div className="place-self-center bg-yellow-50 shadow-sm rounded-lg overflow-hidden relative w-96 p-6 box-border text-black">
      <div className="flex justify-between align-middle ">
        <p className="font-bold my-2 text-2xl">{userName}의 면제권</p>
        {enable && (
          <button className="bg-yellow-300 hover:shadow-lg py-2 px-4 rounded text-xl">
            사용하기
          </button>
        )}
      </div>
